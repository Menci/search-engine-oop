...
public:    
    ...
    public:
        ...
        StringEx getTextContent(bool ignoreScriptAndStyle = true) const {
            checkNotNull();
            StringEx result;
            HTMLDocument::internelGetTextContent(node.get(), result, ignoreScriptAndStyle);
            return result;
        }
...
private:
    ...
    static void internelGetTextContent(const DOM::NodeWithChildren *node, StringEx &result, bool ignoreScriptAndStyle);
...
public:
    ...
    StringEx getTextContent(bool ignoreScriptAndStyle = true) const {
        StringEx result;
        HTMLDocument::internelGetTextContent(&domRoot, result, ignoreScriptAndStyle);
        return result;
    }
